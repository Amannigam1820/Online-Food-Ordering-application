...
function initadmin(socket) {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n                <p>".concat(menuItem.item.name, " - ").concat(menuItem.qty, " pcs </>\n            ");
    }).join('');
  }
...
function placeOrder(formObj) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/orders', formObj).then(function (res) {
...
var statuss = document.querySelectorAll('.status-line');
...
updateStatus(order);
(0,_stripe__WEBPACK_IMPORTED_MODULE_3__.initStripe)(); // socket client side
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_2__.loadStripe)('pk_test_51Jt3EeSFIB6g0JZ9gK0DOBnuHyCmbeuSsqxwFiAWpMBn21KGK9zm6UynCHcrrNMhiLXytD0fxOGfCMaemgiHCAS8003hL5dFTs');
